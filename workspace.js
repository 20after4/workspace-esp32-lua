  ...
  if err then
    ...
    print("-- Total APs: ", #arr)
        ...
        loadMicropythonEditor: function() {
            ...
            var that = this;
            chilipeppr.load(
                "#com-chilipeppr-widget-pythoneditor-instance",
                "https://raw.githubusercontent.com/20after4/widget-pythoneditor/master/auto-generated-widget.html",
                function() {
                    require(['inline:com-chilipeppr-widget-pythoneditor'], function(pythoneditor) {
                        that.widgetPythonEditor = pythoneditor;
                        pythoneditor.init();
                        pythoneditor.resize();
                    });
                }
