...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-esp32-micropython |
| Name                  | Workspace / ESP32 for Micropython (NodeMCU) |
| Description           | A ChiliPeppr Workspace that lets you interact with an ESP32 Micropython device (NodeMCU for ESP32). The device is an ESP32 wifi module with an attached USB serial port bridge so you can easily use it and program it from your computer via the serial port. Thus, the esp32 works brilliantly with ChiliPeppr. Secondly, the esp32 has the Micropython language preloaded onto it so you can easily program the device.This workspace gives you convenience methods for programming the esp32 device. You can buy the esp32 on ebay.com or aliexpress.com. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/20after4/workspace-esp32-micropython/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/undefined/undefined |
| Github URL            | http://github.com/20after4/workspace-esp32-micropython |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/20after4/workspace-esp32-micropython/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-esp32-micropython"], // the id you gave your workspace
      function(myWorkspaceEsp32Micropython) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / ESP32 for Micropython (NodeMCU) just got loaded.", myWorkspaceEsp32Micropython);
        myWorkspaceEsp32Micropython.init();
      }
    );
  }
);
